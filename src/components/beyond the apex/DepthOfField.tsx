import i1Fxh9UM1pypRb from "../../assets/images/i1Fxh9UM1pypRb.webp";
import i1OfFcf1Lod7AcE from "../../assets/images/i1OfFcf1Lod7AcE.webp";
import i1PylXNiucP0m8E from "../../assets/images/i1PylXNiucP0m8E.webp";
import i1eQlJHBtTm3jz from "../../assets/images/i1eQlJHBtTm3jz.webp";
    ...
    <div className="manual_detail">
      ...
      <div className="body">
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            用相机对准某被摄体对焦，该部分会清晰呈现。合焦部分在焦点前后延伸的范围称为「景深」。前后合焦范围大称「景深深」，仅对焦点锐利、前后虚化称「景深浅」。
          </p>
        </div>

        <p className="image">
          <img alt="" src={i1Fxh9UM1pypRb} />
        </p>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            拍摄汽车时，起初目标是全画面清晰合焦（「全景深」）。宜用广角镜头并逐渐收小光圈（增大 f 值）。若以「正面 7:3」为例，对焦点可瞄准车灯。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            闲话一句：我年轻时目录拍摄常用 4×5 等大画幅相机。4×5 连对焦都极难，全景深更是奢望。f 值 16、22 是家常便饭，甚至有 f/64。「要练十年才能拍好」——我自己也被折腾得够呛（笑）。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            能拍清全画面后，不妨冒险一试：换上长焦镜头，积极开大光圈拍摄。被摄体会从背景中分离，呈现独特韵味。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            浅景深冲击力更强，拍整车时不如瞄准尾灯或后翼等局部特写来得猛烈。雾天或背后有巨型建筑时，也能让车辆从背景中跃出，效果拔群。
          </p>
        </div>
      </div>
    </div>
