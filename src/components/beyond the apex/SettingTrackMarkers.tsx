import i1rRS7lnwiF7CTH from "../../assets/images/i1rRS7lnwiF7CTH.webp";
    ...
    <div className="manual_detail">
      ...
      <div className="body">
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            先启动《GT 赛车 7》，在执照模式的「起步与停车（B-1、B-2）」中挑战。能否在停车区内干净停下？速度越快，完全停车所需时间越长，找准制动点（开始制动的时机）就越难。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            例如部分赛道设有「100m」「50m」等标志，表示距前方弯道的距离。以此作为制动点练习。若制动过早、在停车区前就停下，就把制动点推迟到标记之后；若制动过晚、冲过停车区，就把制动点提前到标记之前。反复练习可摆脱纯靠感觉的制动，稳定在同一位置停下。
          </p>
        </div>

        <p className="image">
          <img alt="" src={i1rRS7lnwiF7CTH} />
        </p>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            并非每条赛道都有距离标志，请利用一切可用物作临时标记：裁判岗、路缘石、看台，甚至赛道旁的花草。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            F1 车手也会在比赛周初步行勘察赛道，仔细观察以发现对手可能忽略的「标记」。
          </p>
        </div>
      </div>
    </div>
