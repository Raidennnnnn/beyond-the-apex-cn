    ...
    <div className="manual_detail">
      ...
      <div className="body">
        <div className="bilingual">
          ...
          <p lang="zh">
            转子发动机调校的关键是提高进气效率：扩大进气口，把更多混合气送入燃烧室。这本身与往复发动机装入高凸轮的效果相似，但须注意：端口移位或扩大会使功率提升幅度与特性大幅改变。例如竞赛专用「周边进气口」低速扭矩极端偏小，日常驾驶极难驾驭。转子发动机在结构上排气口与涡轮间距短，能用排气能量高效转动涡轮；把端口调校与涡轮调校组合，可更有效地抬高潜力。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p className="caption" lang="zh">
            转子发动机与涡轮匹配优异也是魅力之一；兼顾高输出与易驾性的「端口调校＋涡轮」是定番。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            与往复发动机相比结构更简单、零件更少，提高各零件精度并细致组装，即可拉出本应有的潜力。关键是称为「密封组」的作业：把相当于往复机活塞环的 apex 密封全部调到相同间隙后重装，壳体内的转子便可在保持正确压缩的同时极为顺滑地旋转。反过来说，密封不良会直接导致输出下降，最坏还会诱发咬死。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            扩大设于侧面壳体的进气口直径，可比通常更早（更多）吸入混合气以提高功率，效果与往复发动机装高凸轮相同。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            侧面进气调校手法之一；削出的端口形状恰似架着一座桥，因而得名。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            两个端口口之间留下「桥」，是因为端口扩到接近极限时，仍须保留 apex 密封通过的轨迹。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            用特殊粘接剂封住原厂设于侧面壳体的进气口，改移到转子壳体上部。混合气被直接送入转子壳体内，高转速区可拉出巨大功率；另一方面，原厂（侧面进气）靠低速／高速分段送气以保障常用转速扭矩的功能会丧失，与高转速压倒性功率形成对照，几乎不产生低速扭矩，特性一变为尖峰。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            亦称交叉端口（cross-port），把侧面进气（或桥式端口）与周边进气组合：低转速区仅侧面进气工作，高转速区仅周边进气工作的顺序方式，兼得各自优点。
          </p>
        </div>
      </div>
    </div>
