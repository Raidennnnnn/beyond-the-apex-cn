    ...
    <div className="manual_detail">
      ...
      <div className="body">
        <div className="bilingual">
          ...
          <p lang="zh">
            发动机在活塞上推、压缩混合气时用力越大，燃烧力越高，越能拉出更大功率与扭矩。此处调校的关键是气缸盖燃烧室容积的设计。但压缩比提得过高，会变成转动（压缩）发动机时的阻力，并可能引发异常燃烧。除燃油调整外，还须推迟点火、换用冷型火花塞，以及针对爆炸力增大而对活塞、连杆等做强化。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p className="caption" lang="zh">
            提高压缩比按理应与提高转速同步进行；燃烧力变大，发动机内部也须加固。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            提高压缩比方面，最具代表性的调校是换装高压缩（high-comp）活塞。从顶部呈凸状也可看出：相对原厂活塞形状缩小燃烧室容积以提高压缩比。但高压缩会使混合气温度、燃烧温度升高，更容易产生爆震＝异常燃烧，须采取改善混合气流动等对策。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            燃烧室加工中，大动作可做成进排气与点火效率更优的屋脊型等，但伴随高压缩的爆震对策「挤压面加工」才是主角：削去燃烧室内压力偏高的挤压区（下图灰色部分），略微降低压缩比。不过做此加工后各燃烧室容积会出现偏差，须同时精密测量燃烧室容量。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            将气缸盖下平面以约 0.1 mm 为单位研磨，一般称作「缸盖平面研磨」。基本目的是缩小燃烧室容积以提高压缩比。在发动机处于严苛热工况时，也用于修正气缸体与气缸盖之间的热变形（＝压缩泄漏的原因之一）。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            夹在气缸盖与气缸体之间、保持气密、防止压缩泄漏的垫片即缸垫。将其厚度相对原厂减薄，也可获得与缸盖平面研磨相同的效果——缩小燃烧室容积以提高压缩比。近年有的垫片采用导热高、强度好的不锈钢材料，在防止吹垫的同时兼顾压缩比的合理化。
          </p>
        </div>
