    ...
    <div className="manual_detail">
      ...
      <div className="body">
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            车轮定位中有代表性的设定是外倾角调整。从正面看车时，呈「八」字形、轮胎下侧张开的是负外倾；相反下侧收拢的是正外倾。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            过弯时车身因离心力向弯外倾斜。预见到这一倾斜而把轮胎设为负外倾，就能在弯中使轮胎正立于路面、切实施加牵引力。所谓「加外倾角」，几乎可以肯定是指追求这种负外倾效果。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            但以弯中「站得住」为目的的负外倾，直线时当然会产生坏处：轮胎不正立于路面，方向盘易被车辙带走，牵引力也难加上。轮胎还会变成阻力使加速下降，接地面积减少也可能拉长制动距离。负外倾越强，这些直线坏处越突出，在做极端设定前须把利弊记清楚。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            实际设定负外倾时，要考虑过弯中前后轮胎的重量平衡：前载荷大则前轮负外倾角度偏大、后轮角度偏小。如此应能改善车辆的转向不足倾向。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            另一方面正外倾会降低轮胎抓地绝对值，称不上现实设定；车辆举动会变得过敏，宜避免。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            是从上方看车体时轮胎「脚尖」部分的角度调整。前束对左右载荷平衡崩坏时的特性影响很大。例如过弯时载荷移向外侧轮，外侧轮朝向对举动影响很大；前束角调整正是通过决定此时轮胎朝向，承担决定车辆稳定性的角色。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            相对前进方向轮胎朝内称「前束内（toe-in）」，朝外称「前束外（toe-out）」。从操控特性看，基本上前部做前束内、后部做前束外会倾向转向过度；相反设定则倾向转向不足。也有为使过弯时前部动作更沉稳而设定前束外的情况。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            不过前束与轴距、轮距、外倾角，乃至发动机功率与驱动布局都密切相关。调整多作为最后一步，用来修正其他部分补不完的车辆特有脾气，或给操控性做细微调味。加角度也会增加行驶阻力，很少做大角度变更。尤其后部角度变更对行驶性能与操控影响大，原则上以前部为主、在微小范围内调整。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            利用钢材棒扭转时产生的反力之弹簧称扭杆弹簧；防倾杆是用这种扭杆弹簧连接左右悬架下控制臂而成。过弯时一侧悬架运动，另一侧成为阻力，以试图把运动侧悬架拉回的力抑制车身侧倾，提高轮胎接地。与螺旋弹簧同样以刚度表示软硬，加强前部则转向响应也提高。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            设定时须注意：不要把刚度设得高于悬架弹簧。防倾杆过强时，支承载荷的外侧轮运动会使弹簧不敌防倾杆、朝同方向运动，内侧轮浮起发生内轮抬起，得不到足够牵引力。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            也可靠前后刚度组合在一定程度上调整操控特性，但悬架设定归根结底以减振器衰减力与弹簧刚度的组合为基本。再加上防倾杆刚度，设定会过于复杂、难以抓住要点。把防倾杆调整当作最后调味程度更稳妥。
          </p>
        </div>
      </div>
    </div>
