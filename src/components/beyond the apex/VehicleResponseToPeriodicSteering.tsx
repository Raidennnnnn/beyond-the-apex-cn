    ...
    <div className="manual_detail">
      ...
      <div className="body">
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            上一节说明了车辆运动也可视为振动现象。这里用振动理论分析周期性转向输入下的响应，以看清转向特性如何影响整体车辆行为：在恒定车速下反复“打舵—回正”，并改变转向输入的速率（转向频率）。
            <br />
            <br />
            如 1-7 所述，可用波特图分析频率响应。图 2-4-1 是周期性转向输入下横摆角速度响应的波特图。转向频率极低时，增益（振幅比）与定常圆周行驶中不足转向、中性转向、过度转向的稳态表现基本一致。频率升高后，不足转向车辆增益上升，并在某一频率达到峰值；中性转向或过度转向则无明显峰值，增益随频率升高而下降。
            <br />
            <br />
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            实际使用波特图时，有若干关键点。以横摆角速度的频率响应为例：第一是极低频增益（图 2-4-2 的 (1)），该值与定常圆周行驶响应基本一致。第二是增益峰值高度（(2)）：不足转向越强，某些频率下横摆阻尼越小，峰值越明显；中性或过度转向峰值往往不明显。对均衡的转向特性，适度共振峰更理想。第三是共振频率（(3)）：越高通常响应越快，驾驶员更能感到舵效锐利。第四是相位滞后（(4)）：滞后越大，横摆角速度建立越慢；减小相位滞后有助于获得更敏捷的转向手感。
          </p>
        </div>
