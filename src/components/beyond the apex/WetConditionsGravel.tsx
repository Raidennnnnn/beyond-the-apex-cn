    ...
    <div className="manual_detail">
      ...
      <div className="body">
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            理所当然，雨天路面 μ（摩擦系数）变低，总体抓地会大幅减少。以下列举雨天比赛时的基本设定。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            弹簧刚度、减振器、防倾杆相对干地大幅改向柔软（有时拆掉后防倾杆）。底盘过硬则轮胎不易接地，极限区可能突然打滑。硬底盘本就在总体抓地高时才需要，低抓地的湿地可视为不必要。外倾比干地略「立起」，以赚取加减速时的轮胎接地面积。可调空力的车辆则前后都增加下压力，把抓地提到最大。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            附带一提，实战中最简单的湿地设定是胎压调整。雨大则把胎压调得比干地高、缩小接地面，靠提高单位面积载荷防止打滑漂浮；雨量少时也可能相反放气。调整胎压在微调前后抓地力时也省事，可谓设定的第一步。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            若能改变发动机特性，则比顶端功率更重视中低转速扭矩。湿地比赛时，依赖电子装置往往更可控、更快的情况也很多；感受有无电子控制装置带来的举动差异，也是一种乐趣。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            砂石设定中最重要的是自由自在的可控性。未铺装路面状况不稳定，稍改行驶线路路面摩擦系数就大变。前车溅起砂石也是家常便饭，按出发顺序路面状况也大不同。可认为赛道那种「瞄准极限高度」的设定无法应对路面变化。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            对应这类路面的思路之一，与驱动方式无关：「收油时车头朝弯内、加油时呈中性转向的设定」。故意把基本做成「转过头」，再设想用油门修正的驾驶。具体可使用 2WAY LSD，或把制动前后平衡设得偏前。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            转向不足与转向过度的对策，与铺装路面同一思路即可。合适车高随路面大变：能降则降是正道，但深车辙或大石块的赛道会伤车。跑有跳跃的赛道，还应追求考虑滞空姿态的前后空力平衡。发动机特性比顶端功率更宜尽量提高响应。
          </p>
        </div>
