import i171e5swG7fQ7SH from "../../assets/images/i171e5swG7fQ7SH.webp";
import i1CfnnrYO5uKY from "../../assets/images/i1CfnnrYO5uKY.webp";
import i1OOoxd2Mma34 from "../../assets/images/i1OOoxd2Mma34.webp";
import i1nAROoOvFRrlSB from "../../assets/images/i1nAROoOvFRrlSB.webp";
    ...
    <div className="manual_detail">
      ...
      <div className="body">
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            描述光线色彩性质的单位称为「色温」。或许有人会想，颜色怎么会有温度。正午阳光（日光）的色温约 5500K（开尔文）；清晨偏蓝的光约 6500K；夕阳偏红的光约 3800K。
          </p>
        </div>

        <p className="image">
          <img alt="" src={i1nAROoOvFRrlSB} />
        </p>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            昔日用胶片拍摄，胶片针对正午阳光优化了色彩平衡，因此清晨拍摄整体偏蓝，傍晚偏红，再用滤镜校正到合适的色味。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            数码相机登场后，色温可自由调节。设为自动，清晨或夕阳也能以中性色彩平衡拍摄，但我觉得乏味——为落日红光感动而按下快门，就该保留红色；为黎明青蓝早起拍摄，就该强调蓝色。「再现自己感受到的颜色」——这是我的想法。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            「景观」也可调色温。构图与光影定好后，最后请留意色温，画面会更有深度。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            稍微跑题：常听人说「东京和加州拍同样场景，发色完全不同」。我初次离开日本赴欧洲拍摄（当时仍用胶片）时，看到成片差异之大，至今记忆犹新。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            原因之一或许是湿度的差异。低湿度的地方远景通透，有时能拍到惊人清澈的照片。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            再一个是光线所携带的信息不同。平时未必察觉，光会反射周遭一切风景。例如英国是牧草的绿色、砖房街的棕色；加州则是灌木丛生的沙地色调融入光中，形成独特照明。地点不同，照片便不同——我想这就是原因。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            「景观」收录了世界各地的风景。边玩边思考这些，或许是一种全新的摄影乐趣。
          </p>
        </div>
      </div>
    </div>
