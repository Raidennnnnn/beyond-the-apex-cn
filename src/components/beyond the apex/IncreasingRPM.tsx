    ...
    <div className="manual_detail">
      ...
      <div className="body">
        <div className="bilingual">
          ...
          <p lang="zh">
            功率即「扭矩×转速」，因此高出力取决于「能把发动机转得多高」。此处调校以气缸盖相关为主，关键是提高高转速区的进排气效率。主流是换用凸轮作用角更大的高凸轮；同时须强化气门周边，但可获得与扩大进排气气道相同的效果，在高转速区带来压倒性功率。从发动机特性看，更适合高转速的是短行程型：进排气效率高，且与长行程型相比活塞速度本身也不那么高。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p className="caption" lang="zh">
            仅更换高凸轮即可把发动机特性一变为高转速·高输出型；另一方面，低中转速扭矩会极端变细，纯赛车用途甚至可能无法怠速。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            混合气与燃烧后废气的通道——进气／排气气道——越光滑越好；但因成本，原厂发动机很少细致精加工，反而成了进排气阻力。铸造面特有的粗糙、孔径绝对尺寸、变形等问题即属此类。将其研磨至镜面般光洁，以促进顺畅的进排气。仅做气道研磨也能改善高转速感受，但若不与换凸轮、缸盖平面研磨等气缸盖整体调校同时进行，往往难以发挥本应有的效果。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            凸轮轴是开闭进排气门的轴；高凸轮＝高升程凸轮，即把凸轮凸起加高、延长气门开启时间的凸轮轴，可获得与扩大进排气气道相同的效果。低中转速扭矩变细，高转速功率则急剧提升。虽难免尖峰特性，却是自然吸气发动机追求高输出时的定番调校。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p className="caption" lang="zh">
            右为原厂凸轮，左为高凸轮。凸起更高，高凸轮就能把气门开得更大。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            与气道研磨、换凸轮同时应考虑的是加大气门：扩大进气门侧开口面积以增加进气量、提高充气效率。气门越大越重（惯性越大），对策上多做成超轻的钛制气门。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            高转速运转时气门弹簧会产生异常振动，即「颤振」（弹簧伸缩速度跟不上凸轮运动的状态）；为防此现象，强化弹簧不可或缺。尤其装入高凸轮时几乎必须——若仍用原厂弹簧，气门升程增大后弹簧承受不住，最坏可使弹簧并圈而凸轮锁死，或气门与活塞接触。但弹簧过强也会成为发动机阻力，并加快气门周边磨损，须注意。
          </p>
        </div>
