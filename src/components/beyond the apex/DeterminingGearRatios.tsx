...
<dd><img alt="" src="images\i12ZDsjILjQpo.jpg"/></dd>
<dd className="caption">图8-1：紧密比齿轮设置的示例。在连续弯道的赛道中，通过将齿轮设置得更紧密来专注于加速性能。</dd>
</dl>
<dl className="image_list">
<dd><img alt="" src="images\i1QOa0za6nG1lhB.jpg"/></dd>
...
<p className="image"><img alt="" src="images\i147pswdYzk4B.jpg"/></p>
