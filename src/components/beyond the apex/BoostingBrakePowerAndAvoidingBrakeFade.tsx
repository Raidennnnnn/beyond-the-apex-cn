    ...
    <div className="manual_detail">
      ...
      <div className="body">
        <div className="bilingual">
          ...
          <p lang="zh">
            经发动机调校后绝对速度提高的车辆，需要更强制动力与更高抗热衰退性能。基础层面有换刹车片，终极可把制动系统本身换成大容量赛车用等，按程度有多种菜单。但赛车用未必在所有用途都能完美发挥，须按目的选件。盘与卡钳加大也会增加簧下质量、妨碍运动性。制动性能应超过发动机功率是铁则；若在轻车上装极端大容量系统，则明显过剩品质，也可能打乱行驶平衡。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            制动调校中最基本、又大幅左右制动力与抗衰退性的零件。从街道用到竞赛用选择很广，但各自的合适温度（发挥最大制动力的温度）与耐热温度不同，选得不合目的就得不到预期效果，甚至对行驶产生负面影响。相对原厂磨损更快、对盘攻击性也更高。为保持制动平衡，原则上前后成套更换。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            液压制动所用的工作液。赛车用为防气阻，即使超过 200℃ 也不沸腾，但吸湿性极高、易劣化。称为 DOT 的等级越高沸点越高，同时更易吸湿劣化（沸点下降）。因此使用赛车专用 DOT5 时，短周期更换是必须的。附带一提，提高 DOT 数本身并不会提高制动力，须注意。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            制动液通道——软管原厂多为橡胶；重刹时液压升高会膨胀，使踏板感发虚。解决办法是所谓不锈钢编织制动软管：特氟龙管外包网状不锈钢，在具备与橡胶同等柔韧性的同时防止膨胀。竞赛车普遍采用的强化件，能始终带来直接、准确的踏板感。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            提高制动力最有效的手段之一是加大制动容量：即加大盘径，产生更大摩擦热。但铸铁大径盘同时增加簧下质量、降低行驶性能，因此近年也开始流通以陶瓷、碳等为主要材料的轻量盘。盘是随使用磨损的消耗件，要获得本应有的制动力，需定期更换或研磨。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            卡钳本体调校中，有升级整套系统的手法。为把刹车片可靠压向制动盘，一般换成从两侧推出片的对向活塞式。从市售车也大量采用六活塞可知，活塞数越多越能使片面压均匀，结果可提高制动力。对向活塞式还常使卡钳本体一体成型、固定于车轴侧不滑动，卡钳本身刚性高，激烈使用下也能获得稳定制动，亦是优点。
          </p>
        </div>
