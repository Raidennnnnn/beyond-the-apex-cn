    ...
    <div className="manual_detail">
      ...
      <div className="body">
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            把二者推到极限的是赛车专用光头胎：接地面称为配方的橡胶靠摩擦热熔化贴紧路面，为确保接地面刚性而一条沟也没有。这一思路在公路用上也同样成立——标榜高性能的轮胎无一例外采用软配方，并具备沟浅、块大的胎面花纹。但湿地要保证排水，沟槽不可或缺，越深越多越有利。如何在高维度上平衡干地性能与湿地性能，是很大的课题。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            加宽轮胎、扩大接地面积，抓地性能必然提高。但轮胎抓地力不仅取决于与路面的摩擦，也随轮胎所受载荷大幅变化。例如轻车上装极端宽胎时，载荷不足、得不到高抓地力也不罕见。另一方面，动力不足的车上装超尺寸轮胎时，功率会被轮胎抓地力吃掉，反而变慢的情况很多。须在考虑车重与输出平衡后再选尺寸。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            英寸升级指降低轮胎扁平率（相对宽度高度为百分之几），在不改变外径的前提下加大轮圈尺寸；未必意味着加宽。主要好处是侧壁宽度（高度）变薄，过弯或制动时轮胎挠曲减少，即靠提高刚性改善转向响应与操控性。但极端英寸升级会因轮圈加大而增加簧下质量，也可能严重损害运动性能。附带一提，竞赛车英寸升级的本来目的，是加大轮径以容纳大容量制动系统。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            用于轮胎接地部位的橡胶称为配方，决定着绝对抓地性能。重视抓地的高性能胎采用易贴路面的软配方；尤其赛车胎靠与路面的摩擦热使表面熔化，利用其粘着力执着抓住路面。但软配方在产生高抓地力的同时磨损快，硬配方则相反。须理解这些基本特性后再区分使用。橡胶还会随时效硬化，抓地相对新胎逐渐下降，软配方这一倾向更强。
          </p>
        </div>
        ...
        <div className="bilingual">
          ...
          <p lang="zh">
            接地面上刻出的沟称为花纹沟，作用是排出湿地路面的水，维持接地面与路面的抓地力。另一方面在干地，过弯、制动或加速对轮胎施加大载荷时，沟槽只会带来接地面扭拧等坏处。最直白的例子是赛道专用光头胎——一条沟也没有。行驶会或周日赛用的半光头胎，也为确保接地面刚性，仅刻极浅、最少的沟。
          </p>
        </div>
      </div>
    </div>
